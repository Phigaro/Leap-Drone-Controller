function FrontMove() {
  ...
  $("#StickImg").attr("src", "./images/Stick00.png");
}

function FrontRightMove() {
  console.log("Front Right. Move");
  $("#StickImg").attr("src", "./images/Stick01.png");
}

function RightMove() {
  console.log("Right Move");
  $("#StickImg").attr("src", "./images/Stick02.png");
}

function BackRightMove() {
  console.log("Back Right. Move");
  $("#StickImg").attr("src", "./images/Stick03.png");
}

function BackMove() {
  console.log("Back. Move");
  $("#StickImg").attr("src", "./images/Stick04.png");
}

function BackLeftMove() {
  console.log("Back Left. Move");
  $("#StickImg").attr("src", "./images/Stick05.png");
}

function LeftMove() {
  console.log("Left Move");
  $("#StickImg").attr("src", "./images/Stick06.png");
}

function FrontLeftMove() {
  console.log("Front Left Move");
  $("#StickImg").attr("src", "./images/Stick07.png");
}

function Stop() {
  $("#StickImg").attr("src", "./images/StickStop.png");
}
...
Leap.loop(controllerOptions, function (frame) {
  ...
  if (frame.hands.length > 0) {
    ...
    $("#StickImg").attr("src", "./images/StickUnDectected.png");
  }
  if (frame.hands.length > 0) {
